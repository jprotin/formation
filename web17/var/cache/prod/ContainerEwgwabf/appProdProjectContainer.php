...
class appProdProjectContainer extends Container
{
    ...
    protected function getDoctrine_Dbal_DefaultConnectionService()
    {
        ...
        return $this->services['doctrine.dbal.default_connection'] = ${($_ = isset($this->services['doctrine.dbal.connection_factory']) ? $this->services['doctrine.dbal.connection_factory'] : $this->services['doctrine.dbal.connection_factory'] = new \Doctrine\Bundle\DoctrineBundle\ConnectionFactory(array())) && false ?: '_'}->createConnection(array('driver' => 'pdo_mysql', 'host' => 'database', 'port' => '3306', 'dbname' => 'prestashop', 'user' => 'root', 'password' => 'admin', 'charset' => 'UTF8', 'driverOptions' => array(1002 => 'SET sql_mode=(SELECT REPLACE(@@sql_mode,\'ONLY_FULL_GROUP_BY\',\'\'))'), 'serverVersion' => 5.0999999999999996, 'defaultTableOptions' => array()), new \Doctrine\DBAL\Configuration(), $a, array('enum' => 'string'));
    }
    ...
    {
        return $this->services['fragment.listener'] = new \Symfony\Component\HttpKernel\EventListener\FragmentListener(${($_ = isset($this->services['uri_signer']) ? $this->services['uri_signer'] : $this->services['uri_signer'] = new \Symfony\Component\HttpKernel\UriSigner('egYOX4PeQxx34DpZLroIjACwL2h6h923cgpgp6DMwLFLxYjuIF9EoqtQ')) && false ?: '_'}, '/_fragment');
    }
    ...
    {
        return $this->services['uri_signer'] = new \Symfony\Component\HttpKernel\UriSigner('egYOX4PeQxx34DpZLroIjACwL2h6h923cgpgp6DMwLFLxYjuIF9EoqtQ');
    }
    ...
    protected function getDefaultParameters()
    {
        return array(
            ...
            'secret' => 'egYOX4PeQxx34DpZLroIjACwL2h6h923cgpgp6DMwLFLxYjuIF9EoqtQ',
            'ps_caching' => 'CacheMemcache',
            'ps_cache_enable' => false,
            'ps_creation_date' => '2018-10-01',
            'locale' => 'fr-FR',
            'cookie_key' => 'J8COt2djMnyLXv4bX8qXYQZ37jcvvOPncDBMPajeHQSZt1iyNhoefXZ3',
            'cookie_iv' => 'u73rmJn9',
            'new_cookie_key' => 'def000002afa6058c36e53551668ed138ed0fa3739938fa8457b93bff1424ef7e250701ad01181668e4affdb8ce5c0f4bd9ad8d1b9766e8b883b01712468b9df9fd29b81',
            'cache.driver' => 'array',
            ...
            'kernel.secret' => 'egYOX4PeQxx34DpZLroIjACwL2h6h923cgpgp6DMwLFLxYjuIF9EoqtQ',
